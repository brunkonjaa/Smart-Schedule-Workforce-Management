...
The final Phase 6 merge is the `v1.0.0-submission` repository snapshot. The application directories in that merge are unchanged from deployed SHA `14e66cfc8c6ced641558e95808dc51e28fd9bb3e`; the later commits only add the release records and screenshot evidence. The hosted rerun gaps are kept as limitations instead of being marked as passes.
